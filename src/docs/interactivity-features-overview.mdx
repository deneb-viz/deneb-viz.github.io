...
-   `__identity__` - this is the raw identity and true row context.
    ...
    -   For those familiar with Power BI visuals development, it is a <OutboundLink href="https://docs.microsoft.com/en-us/power-bi/developer/visuals/selection-api" target="_blank">`SelectionId`</OutboundLink>, which can be passed to Power BI's Selection Manager for [delegation](/interactivity-features-overview/#signaling-back-to-power-bi).
