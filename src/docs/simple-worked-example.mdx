...
> _If you accidentally dismiss the dialog, or it doesn't show then you can bring it up by clicking on the **New Specification** button on the command bar, or using **[Ctrl + Alt + N]**_
...
Now, we can apply our changes by clicking the _Apply_ command (or pressing **[ Ctrl + Enter ]**):
