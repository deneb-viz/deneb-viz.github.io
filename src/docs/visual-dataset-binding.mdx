...
Any data you add to the visual's _Values_ data role is automatically bound to an internal dataset named **`values`** in the Vega or Vega-Lite view. This will update dynamically as you add or remove columns and measures, or the number of rows in the dataset changes (e.g. filter context).
...
If you're used to working with JSON, the above is synonymous to the following object:
...
-   It's generally advised to refer to data from within your model as much as possible.
