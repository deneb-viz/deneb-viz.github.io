...
To ensure correct compatibility with Vega and Vega-Lite, particulalry if you're bringing examples in (or even looking to take them out!) Deneb will use the D3 convention by default, but we're working on evening the odds.
