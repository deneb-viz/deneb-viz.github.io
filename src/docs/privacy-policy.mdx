...
-   This visual is released under the <OutboundLink href="https://en.wikipedia.org/wiki/MIT_License" target="_blank">MIT License</OutboundLink> and is free of charge and <OutboundLink href="https://github.com/deneb-viz/deneb" target="_blank">open source</OutboundLink>.
